...
class PostFormatImage extends PostFormat {
    ...
    ?>
        <div class="pfp-media-holder">
            <?php echo call_user_func( 'bootswatches_postformat_get_the_image_markup', $value ); // WPCS: xss ok. ?>
        </div>
        ...
        <a class="button pfp-js-media-library" data-media="image"
            ...
            <?php echo __( 'Select Image', 'bootswatches'); // WPCS: xss ok. ?>
        </a>

        <span class="pfp-or-hr"><?php __('or use an oembed url', 'bootswatches'); // WPCS: xss ok. ?></span>
        ...
        <a class="pfp-js-remove-media" data-media="image"
            href="#" ><?php echo __( 'Remove Image', 'bootswatches' ); // WPCS: xss ok. ?></a>
