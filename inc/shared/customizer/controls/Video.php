    ...
    class Video extends WP_Customize_Control
    {
        ...
        public function __construct( $manager, $id, $args = array() ) {
            ...
            $this->button_labels = wp_parse_args( $this->button_labels, array(
                'select'       => __( 'Select File', 'bootswatch' ),
                'change'       => __( 'Change File', 'bootswatch' ),
                'default'      => __( 'Default', 'bootswatch' ),
                'remove'       => __( 'Remove', 'bootswatch' ),
                'placeholder'  => __( 'No file selected', 'bootswatch' ),
                'frame_title'  => __( 'Select File', 'bootswatch' ),
                'frame_button' => __( 'Choose File', 'bootswatch' ),
            ) );
