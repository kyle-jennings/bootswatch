...
function bootswatches_get_feed_entry_title( $post = null ) {
    ...
    if ( $post_format === 'link' ) {
        ...
        $link = bootswatches_get_post_format_value( $post->ID, 'link', null );
    }

    $title .= bootswatches_post_format_icon( $post_format );
...
function bootswatches_feed_entry_title( $post = null ) {

    if ( !$post ) {
        global $post;
    }

    echo bootswatches_get_feed_entry_title( $post ); // WPCS: xss ok.
}
 ...
 */
function bootswatches_get_post_format_icon( $format = null ) {
...
function bootswatches_post_format_icon( $format = null ) {
    echo bootswatches_get_post_format_icon( $format ); // WPCS: xss ok.
}