...
class BootswatchesHero {
    ...
    public function __construct($template = null)
    {
        ...
        $this->HeroContent    = new BootswatchesHeroContent(null, $this->template, $this->currentpage);
        $this->HeroBackground = new BootswatchesHeroBG(null, $this->template, $this->currentpage);
