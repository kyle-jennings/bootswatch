...
class BootswatchesHeroContent
{
    ...
    public function _404Content()
    {
        ...
        if($header_page) {
            ...
            $output .= '<h1 class="hero__title">' . __('Page not found', 'bootswatches') . '</h1>';
    ...
    public function heroCallout()
    {
        ...
        $output .= '<div class="hero-callout section-dark">';
            $output .= '<h1 class="hero__title">' . $title . '</h1>';
                ...
                if( !is_null( $id ) && $id != 0 )
                    $output .= '<a class="btn btn-primary"
                        href="' . esc_url(get_the_permalink( $id )) . '">' . __( 'Learn More', 'bootswatches' ) . '</a>';
